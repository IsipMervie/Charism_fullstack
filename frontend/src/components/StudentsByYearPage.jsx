...
function StudentsByYearPage() {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      console.log('PDF Generation URL:', `${process.env.REACT_APP_API_URL || 'https://charism-server-ua-backend.vercel.app/api'}/reports/students-by-year?${params}`);
      console.log('PDF Filters:', pdfFilters);

      const response = await fetch(`${process.env.REACT_APP_API_URL || 'https://charism-server-ua-backend.vercel.app/api'}/reports/students-by-year?${params}`, {
        headers: {
